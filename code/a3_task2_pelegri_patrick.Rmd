...
water_summarize_df <- water_dropna_df %>% 
  ...
  summarize_all(~mean(.x), na.rm = TRUE)  # ...take mean of each column
...
**Dendrogram takeaways**
 - There are three main clusters in the data: ____, ____, ___; ___, ___; and ___
...
```
<br>
**Figure 2:** Tanglegram of aggomerative clustering by complete linkage vs. single linkaage for water chemistry by site in the Santa Barbara Coastal LTER based on data from 2000 to 2005.

**Tanglegram takeaways:**
 - Most stream sites are grouped differently when comparing clustering results by complete linkage vs. single inkage.
